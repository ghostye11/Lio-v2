                ...
                children: [
                  Row(
                    ...
                    children: [
                        ...
                        children: [
                         ...
                         Row(
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                FlutterPhoneDirectCaller.callNumber('+917736759612');
                              },
                      ...
                      Theme(data: Theme.of(context).copyWith(cardColor: Colors.white,iconTheme: IconThemeData(color: Colors.white)),
                  ...
                  Container(
                    ...
                    child: Text("Nurture your mental health, prioritize self-care, and remember your resilience in facing life's challenges.", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900, fontSize: 17),)
                  ),
                  SizedBox(
                    height: 25,
                  ),
                  ...
                  Row(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AlertDialog(
                          ...
                          content: Text("We hope things get better for you soon"),
                          actions: [
                            okButton,
                          ],
                        )));
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AlertDialog(
                          title: Text("Good to hear that!"),
                          content: Text("I hope today bring you more positivity and enjoyment"),
                          actions: [
                            okButton,
                          ],
                        )));
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AlertDialog(
                          title: Text("Thats wonderful to hear!"),
                          content: Text("May the rest of your day be filled with similar joy and success"),
                          actions: [
                            okButton,
                          ],
                        )));
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AlertDialog(
                          title: Text("Wow! Thats fantastic"),
                          content: Text("Wishing you many more incredible experiences and happiness"),
                          actions: [
                            okButton,
                          ],
                        )));
